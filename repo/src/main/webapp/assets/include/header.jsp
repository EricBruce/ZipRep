...
<script type="text/javascript" src="${ctx }/assets/js/jquery-1.8.2.js"></script>
<script type="text/javascript" src="${ctx }/assets/js/jquery-easyui-1.3.4/jquery.easyui.min.js"></script>