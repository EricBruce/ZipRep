package yxs.snake.str.controller;
...
import yxs.snake.str.service.ProductService;
...
public class ProductController {
	...
	public @ResponseBody Map<String,Object> getAlllSelllAmountList(@RequestParam Map<String,Object> condition, HttpServletRequest request) {
		String page = (String)condition.get("page");
		String rows = (String)condition.get("rows");
		//当前页  
		int intPage = Integer.parseInt((page == null || page == "0") ? "1":page);  
...
//		return new ModelAndView("/repo/main/pro_sell_trend");
	...
	public @ResponseBody List<Map<String,Object>> getProductsellTrend(@RequestParam Map<String,Object> condition, HttpServletRequest request) {
